...
public class SelectViewPage extends AbstractMethod {

	public SelectViewPage() {
		this(StringUtils.firstToLowerCase(SelectViewPage.class.getSimpleName()));
	}

	public SelectViewPage(String name) {
		super(name);
	}
