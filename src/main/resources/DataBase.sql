...
INSERT INTO `menus`(id, type, pid, pmid, ref_id, url, name, icon) VALUES
	...
	, (1002, 4, 1001, 11, NULL, '/menus/index', '列表', 'index')
	, (1003, 4, 1001, 12, NULL, '/menus/add', '添加', 'add')
	, (1004, 4, 1001, 13, NULL, '/menus/edit', '编辑', 'edit')
	, (1005, 4, 1001, 14, NULL, '/menus/delete', '删除', 'delete')

	, (1006, 2, 1000, NULL, 1007, NULL, '权限管理', 'man_permission')
	, (1007, 4, 1006, 15, NULL, '/permissions/index', '列表', 'index')
	, (1008, 4, 1006, 16, NULL, '/permissions/add', '添加', 'add')
	, (1009, 4, 1006, 17, NULL, '/permissions/edit', '编辑', 'edit')
	, (1010, 4, 1006, 18, NULL, '/permissions/delete', '删除', 'delete')

	, (1011, 2, 1000, NULL, 1013, NULL, '用户信息', 'man_role')
	, (1012, 3, 1011, NULL, 1013, NULL, '用户管理', 'page')
	, (1013, 4, 1012, 19, NULL, '/users/index', '列表', 'index')
	, (1014, 4, 1012, 20, NULL, '/users/add', '添加', 'add')
	, (1015, 4, 1012, 21, NULL, '/users/edit', '编辑', 'edit')
	, (1016, 4, 1012, 22, NULL, '/users/delete', '删除', 'delete')
	, (1017, 4, 1012, 23, NULL, '/users/reset', '重置密码', 'reset')
	, (1018, 4, 1012, 24, NULL, '/users/authorize', '授权', 'authorize')
	, (1019, 4, 1012, 25, NULL, '/users/assign', '赋予角色', 'assign')
	, (1020, 3, 1011, NULL, 1021, NULL, '删除/注销管理', 'page')
	, (1021, 4, 1020, 26, NULL, '/users/admin/deleted/index', '列表', 'index')
	, (1022, 4, 1020, 27, NULL, '/users/admin/deleted/restore', '恢复', 'backward')
	, (1023, 4, 1020, 28, NULL, '/users/admin/deleted/delete', '永久删除', 'delete')

	, (1024, 2, 1000, NULL, 1025, NULL, '角色管理', 'man_user')
	, (1025, 4, 1024, 29, NULL, '/roles/index', '列表', 'index')
	, (1026, 4, 1024, 30, NULL, '/roles/add', '添加', 'add')
	, (1027, 4, 1024, 31, NULL, '/roles/edit', '编辑', 'edit')
	, (1028, 4, 1024, 32, NULL, '/roles/delete', '删除', 'delete')
	, (1029, 4, 1024, 33, NULL, '/roles/authorize', '授权', 'authorize')

	, (1030, 2, 1000, NULL, 1031, NULL, '数据库管理', 'man_database')
	, (1031, 4, 1030, 34, NULL, '/databases/index', '列表', 'index')
	, (1032, 4, 1030, 35, NULL, '/databases/edit', '管理', 'manage')
	, (1033, 4, 1030, 36, NULL, '/databases/configs/fields/reload', '重载字段配置', 'manage')

	, (1034, 2, 1000, NULL, 1035, NULL, '日志管理', 'man_log')
	, (1035, 4, 1034, 37, NULL, '/logs/index', '列表', 'index')
	, (1036, 4, 1034, 38, NULL, '/logs/delete', '删除', 'delete')
;
