...
-- 用户表
	...
	CREATE TABLE users (
		...
		, delete_time DEFAULT NULL COMMENT '删除/注销时间'
		, delete_type DEFAULT NULL COMMENT '删除方式' -- 0: 注销 1: 删除
	) COMMENT '管理用户的表';
...
-- 字段信息表
	...
	INSERT INTO table_fields_info VALUES ('deleted_usermsgs_view', 1, 1, 0, 0, NULL, 'add_time', NULL);
	INSERT INTO table_fields_info VALUES ('deleted_usermsgs_view', 2, 1, 0, 0, NULL, 'last_login_time', NULL);
	INSERT INTO table_fields_info VALUES ('deleted_usermsgs_view', 3, 1, 0, 0, NULL, 'delete_user', NULL);
	INSERT INTO table_fields_info VALUES ('deleted_usermsgs_view', 4, 1, 0, 0, NULL, 'delete_time', NULL);
...
-- 自动添加新的用户的角色为用户
	...
	INSERT INTO usermsgs(id) VALUES(NEW.id);
...
-- 菜单插入
	...
	INSERT INTO `menus`(id, type, pid, pmid, url, name, icon) VALUES(1036, 4, 1034, 38, '/logs/bulkdelete', '删除', 'delete');
